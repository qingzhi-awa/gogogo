...
.field private final f:Lv0/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILv0/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    invoke-static {v0}, Landroidx/core/util/g;->c(I)I
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lv0/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {p0, p1, v1}, Ls0/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, Lv0/k;->b(Landroid/content/Context;II)Lv0/k$b;

    move-result-object p0

    invoke-virtual {p0}, Lv0/k$b;->m()Lv0/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILv0/k;Landroid/graphics/Rect;)V
...
.method b(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lv0/k;

    invoke-virtual {v0, v2}, Lv0/g;->setShapeAppearanceModel(Lv0/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lv0/k;

    invoke-virtual {v1, v2}, Lv0/g;->setShapeAppearanceModel(Lv0/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lv0/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v3}, Landroidx/core/view/F;->s0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
