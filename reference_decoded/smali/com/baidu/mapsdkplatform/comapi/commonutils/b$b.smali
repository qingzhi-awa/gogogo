...
.method static constructor <clinit>()V
    ...
    const-string v2, "eMonitorVerbose"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;->b:Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    new-instance v2, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    const-string v3, "eMonitorDebug"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;->c:Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    new-instance v3, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    const-string v4, "eMonitorInfo"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;->d:Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    new-instance v4, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    const-string v5, "eMonitorWarn"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;->e:Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    new-instance v5, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    const-string v6, "eMonitorError"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7}, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;->f:Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    new-instance v6, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    const-string v7, "eMonitorRealTime"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8}, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;->g:Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    filled-new-array/range {v0 .. v6}, [Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;

    move-result-object v0

    sput-object v0, Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;->h:[Lcom/baidu/mapsdkplatform/comapi/commonutils/b$b;
