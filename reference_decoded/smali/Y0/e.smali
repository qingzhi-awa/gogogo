...
# static fields
.field public static final b:LY0/e$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, LY0/e$a;-><init>(LY0/g;)V

    sput-object v0, LY0/e;->b:LY0/e$a;

    const-class v23, LX0/n;

    const-class v24, LX0/o;

    const-class v2, LX0/a;

    const-class v3, LX0/l;

    const-class v4, LX0/p;

    const-class v5, LX0/q;

    const-class v6, LX0/r;

    const-class v7, LX0/s;

    const-class v8, LX0/t;

    const-class v9, LX0/u;

    const-class v10, LX0/v;

    const-class v11, LX0/w;

    const-class v12, LX0/b;

    const-class v13, LX0/c;

    const-class v14, LX0/d;

    const-class v15, LX0/e;

    const-class v16, LX0/f;

    const-class v17, LX0/g;

    const-class v18, LX0/h;

    const-class v19, LX0/i;

    const-class v20, LX0/j;

    const-class v21, LX0/k;

    const-class v22, LX0/m;

    filled-new-array/range {v2 .. v24}, [Ljava/lang/Class;

    move-result-object v0

    invoke-static {v0}, LM0/j;->h([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v0, v3}, LM0/j;->n(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v4, v3}, LL0/n;->a(Ljava/lang/Object;Ljava/lang/Object;)LL0/j;
    ...
    :cond_1
    invoke-static {v2}, LM0/z;->g(Ljava/lang/Iterable;)Ljava/util/Map;

    move-result-object v0

    sput-object v0, LY0/e;->c:Ljava/util/Map;
    ...
    sput-object v0, LY0/e;->d:Ljava/util/HashMap;
    ...
    sput-object v2, LY0/e;->e:Ljava/util/HashMap;
    ...
    invoke-static {v2, v7}, LY0/i;->d(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v2, v5, v1, v4, v1}, Le1/g;->o0(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v4, v2}, LL0/n;->a(Ljava/lang/Object;Ljava/lang/Object;)LL0/j;

    move-result-object v2

    invoke-virtual {v2}, LL0/j;->c()Ljava/lang/Object;

    move-result-object v4

    invoke-virtual {v2}, LL0/j;->d()Ljava/lang/Object;
    ...
    :cond_2
    sget-object v0, LY0/e;->c:Ljava/util/Map;
    ...
    :cond_3
    sput-object v3, LY0/e;->f:Ljava/util/HashMap;
    ...
    invoke-static {v3, v5, v1, v4, v1}, Le1/g;->o0(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_4
    sput-object v0, LY0/e;->g:Ljava/util/Map;
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    iput-object p1, p0, LY0/e;->a:Ljava/lang/Class;
...
.method public a()Ljava/lang/Class;
    ...
    iget-object v0, p0, LY0/e;->a:Ljava/lang/Class;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, LW0/a;->b(Lc1/b;)Ljava/lang/Class;

    move-result-object v0

    check-cast p1, Lc1/b;

    invoke-static {p1}, LW0/a;->b(Lc1/b;)Ljava/lang/Class;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, LY0/e;->a()Ljava/lang/Class;
