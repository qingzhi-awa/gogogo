...
.method public constructor <init>(LE0/c;I)V
    ...
    iput-object v0, p0, LG0/b;->b:Landroid/graphics/Paint;

    invoke-static {}, LG0/h;->c()Landroid/graphics/RectF;

    move-result-object v0

    iput-object v0, p0, LG0/b;->c:Landroid/graphics/RectF;

    invoke-static {}, LG0/h;->b()Landroid/graphics/Rect;

    move-result-object v0

    iput-object v0, p0, LG0/b;->d:Landroid/graphics/Rect;

    iput-object p1, p0, LG0/b;->a:LE0/c;

    iput p2, p0, LG0/b;->e:I
...
.method public drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    :cond_0
    iget-object p5, p0, LG0/b;->b:Landroid/graphics/Paint;

    invoke-virtual {p5, p2}, Landroid/graphics/Paint;->set(Landroid/graphics/Paint;)V

    iget-object p2, p0, LG0/b;->a:LE0/c;
    ...
    :try_start_0
    iget-object p5, p0, LG0/b;->a:LE0/c;

    invoke-virtual {p5}, LE0/c;->j()I

    move-result p5

    iget-object p7, p0, LG0/b;->b:Landroid/graphics/Paint;

    invoke-virtual {p7}, Landroid/graphics/Paint;->descent()F

    move-result p7

    iget-object p8, p0, LG0/b;->b:Landroid/graphics/Paint;
    ...
    iget-object p9, p0, LG0/b;->a:LE0/c;

    invoke-virtual {p9, p7}, LE0/c;->l(I)I
    ...
    :goto_3
    iget-object p4, p0, LG0/b;->b:Landroid/graphics/Paint;
    ...
    :cond_4
    iget-object p4, p0, LG0/b;->d:Landroid/graphics/Rect;

    invoke-virtual {p4, p10, p6, p3, p7}, Landroid/graphics/Rect;->set(IIII)V

    iget-object p3, p0, LG0/b;->b:Landroid/graphics/Paint;

    sget-object p4, Landroid/graphics/Paint$Style;->FILL:Landroid/graphics/Paint$Style;

    invoke-virtual {p3, p4}, Landroid/graphics/Paint;->setStyle(Landroid/graphics/Paint$Style;)V

    iget-object p3, p0, LG0/b;->d:Landroid/graphics/Rect;
    ...
    :cond_5
    :goto_4
    iget-object p4, p0, LG0/b;->c:Landroid/graphics/RectF;
    ...
    iget-object p3, p0, LG0/b;->c:Landroid/graphics/RectF;
...
.method public getLeadingMargin(Z)I
    ...
    iget-object p1, p0, LG0/b;->a:LE0/c;
