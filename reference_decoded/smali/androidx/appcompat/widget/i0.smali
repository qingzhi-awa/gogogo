...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;Z)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Landroidx/appcompat/widget/i0;-><init>(Landroidx/appcompat/widget/Toolbar;ZII)V
...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;ZII)V
    ...
    .line 3
    iput p4, p0, Landroidx/appcompat/widget/i0;->o:I

    .line 4
    iput p4, p0, Landroidx/appcompat/widget/i0;->p:I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/i0;->i:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/i0;->j:Ljava/lang/CharSequence;

    .line 8
    iget-object v0, p0, Landroidx/appcompat/widget/i0;->i:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/i0;->g:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/i0;->q:Landroid/graphics/drawable/Drawable;
    ...
    .line 14
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->G(Ljava/lang/CharSequence;)V
    ...
    .line 17
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->F(Ljava/lang/CharSequence;)V
    ...
    .line 19
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->D(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 21
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 22
    :cond_4
    iget-object p2, p0, Landroidx/appcompat/widget/i0;->g:Landroid/graphics/drawable/Drawable;

    if-nez p2, :cond_5

    iget-object p2, p0, Landroidx/appcompat/widget/i0;->q:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_5

    .line 23
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->y(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->p(I)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->B(Landroid/view/View;)V

    .line 27
    iget p2, p0, Landroidx/appcompat/widget/i0;->b:I
    ...
    .line 31
    iget-object p2, p0, Landroidx/appcompat/widget/i0;->a:Landroidx/appcompat/widget/Toolbar;
    ...
    .line 42
    iget-object p4, p0, Landroidx/appcompat/widget/i0;->a:Landroidx/appcompat/widget/Toolbar;
    ...
    .line 43
    :cond_c
    invoke-direct {p0}, Landroidx/appcompat/widget/i0;->A()I
    ...
    .line 45
    invoke-virtual {p0, p3}, Landroidx/appcompat/widget/i0;->C(I)V

    .line 46
    iget-object p1, p0, Landroidx/appcompat/widget/i0;->a:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {p1}, Landroidx/appcompat/widget/Toolbar;->getNavigationContentDescription()Ljava/lang/CharSequence;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/i0;->k:Ljava/lang/CharSequence;
    ...
    invoke-direct {p2, p0}, Landroidx/appcompat/widget/i0$a;-><init>(Landroidx/appcompat/widget/i0;)V
...
.method private H(Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0, p1}, Landroidx/core/view/F;->r0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method private I()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/i0;->k:Ljava/lang/CharSequence;
...
.method private J()V
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/widget/i0;->q:Landroid/graphics/drawable/Drawable;
...
.method public B(Landroid/view/View;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/appcompat/widget/i0;->d:Landroid/view/View;
...
.method public C(I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/i0;->t(I)V
...
.method public D(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/i0;->K()V
...
.method public E(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/i0;->I()V
...
.method public G(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/i0;->H(Ljava/lang/CharSequence;)V
...
.method public a(Landroid/view/Menu;Landroidx/appcompat/view/menu/m$a;)V
    ...
    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/b;->m(Landroidx/appcompat/view/menu/m$a;)V
...
.method public p(I)V
    ...
    :cond_0
    invoke-direct {p0}, Landroidx/appcompat/widget/i0;->J()V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/i0;->i:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/Toolbar;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/appcompat/widget/i0;->a:Landroidx/appcompat/widget/Toolbar;

    iget-object v2, p0, Landroidx/appcompat/widget/i0;->j:Ljava/lang/CharSequence;
...
.method public s(I)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/i0;->c()Landroid/content/Context;
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/i0;->D(Landroid/graphics/drawable/Drawable;)V
...
.method public t(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/i0;->E(Ljava/lang/CharSequence;)V
...
.method public v(IJ)Landroidx/core/view/L;
    .locals 2
    ...
    invoke-virtual {v0, p2, p3}, Landroidx/core/view/L;->e(J)Landroidx/core/view/L;

    move-result-object p2

    new-instance p3, Landroidx/appcompat/widget/i0$b;

    invoke-direct {p3, p0, p1}, Landroidx/appcompat/widget/i0$b;-><init>(Landroidx/appcompat/widget/i0;I)V

    invoke-virtual {p2, p3}, Landroidx/core/view/L;->g(Landroidx/core/view/M;)Landroidx/core/view/L;
